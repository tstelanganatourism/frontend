        ...
        <div className="min-h-screen bg-[#F0F8FF] flex flex-col justify-between font-sans antialiased text-[#0d2f5e]">
          ...
          <main className="flex-1 max-w-6xl w-full mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20">
            ...
            <div className="flex-1 w-full max-w-md md:max-w-lg">
              <svg viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto drop-shadow-2xl">
                <rect width="500" height="400" rx="24" fill="white" />
                <path d="M50 350C120 280 200 300 250 350" stroke="#E6F2FF" strokeWidth="4" strokeLinecap="round" />
                <path d="M300 350C350 250 420 280 480 350" stroke="#E6F2FF" strokeWidth="4" strokeLinecap="round" />
                <path d="M240 80C240 70 250 60 265 60C280 60 290 75 290 85C300 85 308 93 308 103C308 113 300 120 290 120H240C230 120 222 112 222 102C222 92 230 80 240 80Z" fill="#E1F0FF" opacity="0.8" />
                ...
                <path d="M220 200C220 185 240 180 268 180C296 180 316 200V280H220V200Z" fill="#2563EB" />
                <circle cx="268" cy="155" r="16" fill="#F59E0B" />
                <path d="M252 155C252 165 260 174 268 174C276 174 284 165 284 155H252Z" fill="#0F172A" />
                <circle cx="268" cy="148" r="12" fill="#0F172A" />

                <path d="M220 200C180 205 150 240 150 250" stroke="#2563EB" strokeWidth="14" strokeLinecap="round" />
                <circle cx="150" cy="250" r="7" fill="#F59E0B" />
                <path d="M316 200C356 205 386 240 386 250" stroke="#2563EB" strokeWidth="14" strokeLinecap="round" />
                <circle cx="386" cy="250" r="7" fill="#F59E0B" />

                <path d="M150 250C130 270 120 300 130 330" stroke="#10B981" strokeWidth="3" strokeLinecap="round" fill="none" />
                <rect x="138" y="235" width="14" height="20" rx="4" transform="rotate(-45 138 235)" fill="#10B981" />
                <line x1="126" y1="230" x2="132" y2="224" stroke="#D1FAE5" strokeWidth="3" />
                <line x1="132" y1="236" x2="138" y2="230" stroke="#D1FAE5" strokeWidth="3" />

                <path d="M386 250C410 270 430 290 410 320" stroke="#10B981" strokeWidth="3" strokeLinecap="round" fill="none" />
                <rect x="386" y="245" width="14" height="20" rx="4" transform="rotate(45 386 245)" fill="#10B981" />
                <circle cx="394" cy="245" r="2" fill="#047857" />
                <circle cx="400" cy="251" r="2" fill="#047857" />

                <path d="M210 350C210 320 220 290 230 280C230 310 220 335 210 350Z" fill="#3B82F6" />
                <path d="M212 350C225 325 240 310 245 295C240 315 225 338 212 350Z" fill="#F59E0B" />
