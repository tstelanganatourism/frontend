              ...
              >
                ...
                <div className="relative h-48 sm:h-52 overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute top-3 right-3 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/90 backdrop-blur-md shadow-sm border border-slate-200/60 z-10">
                    <Package className="w-3.5 h-3.5 text-[#1598a1]" />
                ...
                <div className="p-5 flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 group-hover:text-[#1598a1] transition-colors duration-200 mb-2">
                      {cat.name}
                    </h3>
                    <p className="text-slate-600 text-xs sm:text-sm leading-relaxed line-clamp-2 mb-4">
                      {cat.description || 'Curated boat rides, temple visits, and scenic travel packages.'}
                    </p>
                  </div>

                  {/* Footer Link */}
                  <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-[#1598a1] group-hover:text-[#0f3d56] transition-colors">
                    <span>Browse Packages</span>
                    <div className="w-7 h-7 rounded-full bg-[#1598a1]/10 flex items-center justify-center group-hover:bg-[#1598a1] group-hover:text-white transition-all">
