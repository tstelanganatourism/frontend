      ...
      <div className="bg-[var(--color-brand-river)] py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl space-y-5">
            <div className="shimmer-surface h-8 w-44 rounded-full bg-white/10" />
            <div className="shimmer-surface h-14 w-full max-w-sm rounded-2xl bg-white/10" />
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          ...
          <main className="lg:col-span-3">
            <div className="shimmer-surface mb-6 h-5 w-40 rounded-full bg-slate-100" />
            <ShimmerGrid count={6} />
          </main>
        </div>
      </div>
