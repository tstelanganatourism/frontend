...
export const SectionNav = () => {
  ...
  return (
    <div className="sticky top-[56px] sm:top-[64px] z-30 border-b border-slate-200 bg-white shadow-xs">
              ...
              <button
                ...
                className={`flex min-h-10 items-center gap-2 rounded-full px-4 py-2 text-sm font-black transition-all whitespace-nowrap
                  ${isActive 
                    ...
                    : 'bg-slate-100/80 text-slate-650 hover:bg-teal-500/10 hover:text-[#0d6e75]'
                  }`}
              >
